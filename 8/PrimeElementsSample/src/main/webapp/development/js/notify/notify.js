...
this.closeIcon.on("click.puinotify",function(){b.hide()
})
},show:function(d){var c=this;
if(d){this.update(d)
}this.element.css("z-index",++PUI.zindex);
this._trigger("beforeShow");
if(this.options.animate){this.element.slideDown(this.options.effectSpeed,this.options.easing,function(){c._trigger("afterShow")
})
}else{this.element.show();
c._trigger("afterShow")
}},hide:function(){var b=this;
this._trigger("beforeHide");
if(this.options.animate){this.element.slideUp(this.options.effectSpeed,this.options.easing,function(){b._trigger("afterHide")
})
}else{this.element.hide();
b._trigger("afterHide")
}},update:function(b){this.content.html(b)
}})
})();